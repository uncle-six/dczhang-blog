...
const BLOG = {
  ...
  // NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '2f12506fe566810e8d27c9e2cdff5a4d',
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '3002506fe5668179b22bfe0012bc6f0a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'dczhang', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '一个杂乱无序的自由体', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dczhang.me', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '阅读分享, 技术分享', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个不爱写代码的程序员,人生三大爱好：读书、远行、退休！,欢迎来到我的博客🎉',
